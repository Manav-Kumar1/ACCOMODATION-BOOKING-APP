    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            next ? 'Please write accomodation info' : 'Choose Images',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  decoration: const InputDecoration(hintText: 'Enter PG Rent'),
                  onChanged: (value) {
                    itemPrice = value;
                  },
                ),
                const SizedBox(height: 5.0,),
                TextField(
                  decoration: const InputDecoration(hintText: 'Enter PG Name'),
                  onChanged: (value) {
                    itemModel = value;
                  },
                ),
                const SizedBox(height: 5.0,),
                TextField(
                  decoration: const InputDecoration(hintText: 'Enter Owner Name'),
                  onChanged: (value) {
                    itemColor = value;
                  },
                ),
                const SizedBox(height: 5.0,),
                TextField(
                  decoration: const InputDecoration(hintText: 'Write some  Description'),
                  onChanged: (value) {
                    description = value;
                  },
                ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      uploadFile().whenComplete(() {
                        ...
                        Fluttertoast.showToast(
                          msg: 'Wohoooo PG added successfully...',
                        );
